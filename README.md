...
```bash
git clone https://github.com/parathaprat/nokiaEmulator.git
cd nokiaEmulator/nokia-3310-emulator
```
...
The optimized production build will be in the `nokia-3310-emulator/dist/` directory.
...
3. Publish directory: `nokia-3310-emulator/dist`
4. Base directory: `nokia-3310-emulator`

### Vercel
1. Import your repository
2. Framework preset: Vite
3. Root directory: `nokia-3310-emulator`
...
│           ├── design.md
│           └── tasks.md
├── nokia-3310-emulator/      # Main application
│   ├── src/
...
This project was developed using the Kiro IDE spec-driven development workflow. The complete specifications are available in the `.kiro/specs/nokia-3310-emulator/` directory:

- **requirements.md** - Detailed feature requirements using EARS syntax
...
- [Report Bug](https://github.com/parathaprat/nokiaEmulator/issues)
- [Request Feature](https://github.com/parathaprat/nokiaEmulator/issues)
